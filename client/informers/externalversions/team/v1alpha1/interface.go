...
type Interface interface {
	// Memberships returns a MembershipInformer.
	Memberships() MembershipInformer
...
// Memberships returns a MembershipInformer.
func (v *version) Memberships() MembershipInformer {
	return &membershipInformer{factory: v.factory, namespace: v.namespace, tweakListOptions: v.tweakListOptions}
}
