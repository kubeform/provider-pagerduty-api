...
import (
	...
	v1alpha1 "kubeform.dev/provider-pagerduty-api/client/listers/addon/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.AddonV1alpha1().Addons(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.AddonV1alpha1().Addons(namespace).Watch(context.TODO(), options)
			},
		},
		&addonv1alpha1.Addon{},
		resyncPeriod,
