	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.ServiceV1alpha1().Dependencies(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.ServiceV1alpha1().Dependencies(namespace).Watch(context.TODO(), options)
			},
		},
		&servicev1alpha1.Dependency{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *dependencyInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&servicev1alpha1.Dependency{}, f.defaultInformer)
}
