...
import (
	...
	v1alpha1 "kubeform.dev/provider-pagerduty-api/client/listers/schedule/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.ScheduleV1alpha1().Schedules(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.ScheduleV1alpha1().Schedules(namespace).Watch(context.TODO(), options)
			},
		},
		&schedulev1alpha1.Schedule{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *scheduleInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&schedulev1alpha1.Schedule{}, f.defaultInformer)
}
