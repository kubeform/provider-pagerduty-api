...
import (
	...
	addon "kubeform.dev/provider-pagerduty-api/client/informers/externalversions/addon"
	business "kubeform.dev/provider-pagerduty-api/client/informers/externalversions/business"
	escalation "kubeform.dev/provider-pagerduty-api/client/informers/externalversions/escalation"
	event "kubeform.dev/provider-pagerduty-api/client/informers/externalversions/event"
	extension "kubeform.dev/provider-pagerduty-api/client/informers/externalversions/extension"
	internalinterfaces "kubeform.dev/provider-pagerduty-api/client/informers/externalversions/internalinterfaces"
	maintenance "kubeform.dev/provider-pagerduty-api/client/informers/externalversions/maintenance"
	response "kubeform.dev/provider-pagerduty-api/client/informers/externalversions/response"
...
func (f *sharedInformerFactory) Escalation() escalation.Interface {
	return escalation.New(f, f.namespace, f.tweakListOptions)
}
...
func (f *sharedInformerFactory) Response() response.Interface {
	return response.New(f, f.namespace, f.tweakListOptions)
}

func (f *sharedInformerFactory) Ruleset() ruleset.Interface {
	return ruleset.New(f, f.namespace, f.tweakListOptions)
}
