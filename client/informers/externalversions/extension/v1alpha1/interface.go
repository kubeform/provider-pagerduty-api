...
type Interface interface {
	...
	// Servicenows returns a ServicenowInformer.
	Servicenows() ServicenowInformer
}
...
// Servicenows returns a ServicenowInformer.
func (v *version) Servicenows() ServicenowInformer {
	return &servicenowInformer{factory: v.factory, namespace: v.namespace, tweakListOptions: v.tweakListOptions}
}
