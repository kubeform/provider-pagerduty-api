...
import (
	...
	v1alpha1 "kubeform.dev/provider-pagerduty-api/client/listers/escalation/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.EscalationV1alpha1().Policies(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.EscalationV1alpha1().Policies(namespace).Watch(context.TODO(), options)
			},
		},
		&escalationv1alpha1.Policy{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *policyInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&escalationv1alpha1.Policy{}, f.defaultInformer)
}
