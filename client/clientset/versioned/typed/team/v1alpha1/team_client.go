...
// TeamV1alpha1Client is used to interact with features provided by the team.pagerduty.kubeform.com group.
type TeamV1alpha1Client struct {
	restClient rest.Interface
}

func (c *TeamV1alpha1Client) Memberships(namespace string) MembershipInterface {
	return newMemberships(c, namespace)
}
