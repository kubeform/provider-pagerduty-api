...
// RulesetsGetter has a method to return a RulesetInterface.
...
// rulesets implements RulesetInterface
type rulesets struct {
	client rest.Interface
	ns     string
}

// newRulesets returns a Rulesets
func newRulesets(c *RulesetV1alpha1Client, namespace string) *rulesets {
	return &rulesets{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *rulesets) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.Ruleset, err error) {
	result = &v1alpha1.Ruleset{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("rulesets").
		Name(name).
...
func (c *rulesets) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.RulesetList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.RulesetList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("rulesets").
...
func (c *rulesets) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *rulesets) Create(ctx context.Context, ruleset *v1alpha1.Ruleset, opts v1.CreateOptions) (result *v1alpha1.Ruleset, err error) {
	result = &v1alpha1.Ruleset{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("rulesets").
...
func (c *rulesets) Update(ctx context.Context, ruleset *v1alpha1.Ruleset, opts v1.UpdateOptions) (result *v1alpha1.Ruleset, err error) {
	result = &v1alpha1.Ruleset{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("rulesets").
...
func (c *rulesets) UpdateStatus(ctx context.Context, ruleset *v1alpha1.Ruleset, opts v1.UpdateOptions) (result *v1alpha1.Ruleset, err error) {
	result = &v1alpha1.Ruleset{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("rulesets").
...
func (c *rulesets) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *rulesets) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *rulesets) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.Ruleset, err error) {
	result = &v1alpha1.Ruleset{}
