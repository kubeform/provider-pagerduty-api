...
// ExtensionV1alpha1Client is used to interact with features provided by the extension.pagerduty.kubeform.com group.
type ExtensionV1alpha1Client struct {
	restClient rest.Interface
}

func (c *ExtensionV1alpha1Client) Extensions(namespace string) ExtensionInterface {
	return newExtensions(c, namespace)
}

func (c *ExtensionV1alpha1Client) Servicenows(namespace string) ServicenowInterface {
	return newServicenows(c, namespace)
}
