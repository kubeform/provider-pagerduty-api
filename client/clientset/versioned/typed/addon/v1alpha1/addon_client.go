...
// AddonV1alpha1Client is used to interact with features provided by the addon.pagerduty.kubeform.com group.
type AddonV1alpha1Client struct {
	restClient rest.Interface
}

func (c *AddonV1alpha1Client) Addons(namespace string) AddonInterface {
