...
// ServiceV1alpha1Client is used to interact with features provided by the service.pagerduty.kubeform.com group.
type ServiceV1alpha1Client struct {
	restClient rest.Interface
}

func (c *ServiceV1alpha1Client) Dependencies(namespace string) DependencyInterface {
	return newDependencies(c, namespace)
}

func (c *ServiceV1alpha1Client) EventRules(namespace string) EventRuleInterface {
	return newEventRules(c, namespace)
}

func (c *ServiceV1alpha1Client) Integrations(namespace string) IntegrationInterface {
	return newIntegrations(c, namespace)
}

func (c *ServiceV1alpha1Client) Services(namespace string) ServiceInterface {
