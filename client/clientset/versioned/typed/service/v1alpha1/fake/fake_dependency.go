...
var dependenciesResource = schema.GroupVersionResource{Group: "service.pagerduty.kubeform.com", Version: "v1alpha1", Resource: "dependencies"}

var dependenciesKind = schema.GroupVersionKind{Group: "service.pagerduty.kubeform.com", Version: "v1alpha1", Kind: "Dependency"}
...
func (c *FakeDependencies) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(dependenciesResource, c.ns, name), &v1alpha1.Dependency{})
