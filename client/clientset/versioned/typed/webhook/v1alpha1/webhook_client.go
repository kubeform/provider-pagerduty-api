...
// WebhookV1alpha1Client is used to interact with features provided by the webhook.pagerduty.kubeform.com group.
type WebhookV1alpha1Client struct {
	restClient rest.Interface
}

func (c *WebhookV1alpha1Client) Subscriptions(namespace string) SubscriptionInterface {
