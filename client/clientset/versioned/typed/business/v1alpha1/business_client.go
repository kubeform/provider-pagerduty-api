...
type BusinessV1alpha1Client struct {
	restClient rest.Interface
}
...
func NewForConfig(c *rest.Config) (*BusinessV1alpha1Client, error) {
	config := *c
	...
	return &BusinessV1alpha1Client{client}, nil
}

// NewForConfigOrDie creates a new BusinessV1alpha1Client for the given config and
// panics if there is an error in the config.
func NewForConfigOrDie(c *rest.Config) *BusinessV1alpha1Client {
...
// New creates a new BusinessV1alpha1Client for the given RESTClient.
func New(c rest.Interface) *BusinessV1alpha1Client {
	return &BusinessV1alpha1Client{c}
}
...
func (c *BusinessV1alpha1Client) RESTClient() rest.Interface {
	if c == nil {
		return nil
	}
	return c.restClient
