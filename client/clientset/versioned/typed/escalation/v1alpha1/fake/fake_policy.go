...
type FakePolicies struct {
	Fake *FakeEscalationV1alpha1
	ns   string
}

var policiesResource = schema.GroupVersionResource{Group: "escalation.pagerduty.kubeform.com", Version: "v1alpha1", Resource: "policies"}

var policiesKind = schema.GroupVersionKind{Group: "escalation.pagerduty.kubeform.com", Version: "v1alpha1", Kind: "Policy"}
