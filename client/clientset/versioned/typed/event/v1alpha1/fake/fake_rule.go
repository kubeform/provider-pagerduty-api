...
var rulesResource = schema.GroupVersionResource{Group: "event.pagerduty.kubeform.com", Version: "v1alpha1", Resource: "rules"}

var rulesKind = schema.GroupVersionKind{Group: "event.pagerduty.kubeform.com", Version: "v1alpha1", Kind: "Rule"}
